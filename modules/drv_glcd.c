...
pDATCTR_Data_t pDATCTR_Data;
  ...
  int put_constant_in_var = GLCD_DEF_DPL_INV;
  GLCD_SendCmd(put_constant_in_var?INVON:INVOFF,NULL,0);
  // Display color scheme setting
  put_constant_in_var = GLCD_DEF_DPL_8_COLOR;
  GLCD_SendCmd(put_constant_in_var?IDMON:IDMOFF,NULL,0);
...
#error "PARTIAL_MODE not supported yet"
  ...
  put_constant_in_var = GLCD_DISPLAY_STATE;
  GLCD_SendCmd(put_constant_in_var?DISPON:DISPOFF,NULL,0);
  return(GLCD_OK);
}
